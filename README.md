...
## Annex. Installation in the TT Server

In these section specific notes are include related to the installation process
in the TT server. The TT Server has a CentOS 7, which has been discontinued. Besides that, it has a special
configuration. Therefore, support for it is only provided by Trading Technologies. These aspects make 
the installation process different.
