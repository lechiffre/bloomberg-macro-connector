...
func (rcv *HeadlineEconomicEvent) EventId() uint64 {
...
func (rcv *HeadlineEconomicEvent) MutateEventId(n uint64) bool {
...
func HeadlineEconomicEventAddEventId(builder *flatbuffers.Builder, eventId uint64) {
