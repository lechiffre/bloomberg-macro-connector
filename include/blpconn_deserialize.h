...
HeadlineEconomicEvent toHeadlineEconomicEvent(
    const FB::HeadlineEconomicEvent* fb_event);
HeadlineCalendarEvent toHeadlineCalendarEvent(
    const FB::HeadlineCalendarEvent* fb_event);
LogMessage toLogMessage(const FB::LogMessage* fb_log_message);

flatbuffers::FlatBufferBuilder buildBufferEconomicEvent(
    HeadlineEconomicEvent& event);
flatbuffers::FlatBufferBuilder buildBufferEconomicEvent(
    const blpapi::Element& elem);
flatbuffers::FlatBufferBuilder buildBufferCalendarEvent(
    HeadlineCalendarEvent& event);
flatbuffers::FlatBufferBuilder buildBufferCalendarEvent(
    const blpapi::Element& elem);
