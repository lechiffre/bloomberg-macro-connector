...
inline const ReleaseStatus (&EnumValuesReleaseStatus())[4] {
    static const ReleaseStatus values[] = {
        ReleaseStatus_Unknown, ReleaseStatus_Released, ReleaseStatus_Scheduled,
...
inline const char *EnumNameReleaseStatus(ReleaseStatus e) {
    switch (e) {
        case ReleaseStatus_Unknown:
            return "Unknown";
        case ReleaseStatus_Released:
            return "Released";
        case ReleaseStatus_Scheduled:
            return "Scheduled";
        case ReleaseStatus_Another:
            return "Another";
        default:
            return "";
    }
...
inline const ModuleType (&EnumValuesModuleType())[7] {
    static const ModuleType values[] = {
        ModuleType_ModuleUnknown, ModuleType_ModuleSystem,
        ModuleType_ModuleSession, ModuleType_ModuleSubscription,
        ModuleType_ModuleService, ModuleType_ModuleHearbeat,
...
inline const char *EnumNameModuleType(ModuleType e) {
    switch (e) {
        case ModuleType_ModuleUnknown:
            return "ModuleUnknown";
        case ModuleType_ModuleSystem:
            return "ModuleSystem";
        case ModuleType_ModuleSession:
            return "ModuleSession";
        case ModuleType_ModuleSubscription:
            return "ModuleSubscription";
        case ModuleType_ModuleService:
            return "ModuleService";
        case ModuleType_ModuleHearbeat:
            return "ModuleHearbeat";
        case ModuleType_ModuleAnother:
            return "ModuleAnother";
        default:
            return "";
    }
}
...
inline const char *EnumNameSessionStatusType(SessionStatusType e) {
    switch (e) {
        case SessionStatusType_SessionUnknown:
            return "SessionUnknown";
        case SessionStatusType_SessionConnectionUp:
            return "SessionConnectionUp";
        case SessionStatusType_SessionStarted:
            return "SessionStarted";
        case SessionStatusType_SessionConnectionDown:
            return "SessionConnectionDown";
        case SessionStatusType_SessionTerminated:
            return "SessionTerminated";
        case SessionStatusType_SessionAnother:
...
inline const EventSubType (&EnumValuesEventSubType())[6] {
    static const EventSubType values[] = {
        EventSubType_Unknown,   EventSubType_New,    EventSubType_Update,
        EventSubType_Unitpaint, EventSubType_Delete, EventSubType_Another};
    return values;
}

inline const char *EnumNameEventSubType(EventSubType e) {
    switch (e) {
        case EventSubType_Unknown:
            return "Unknown";
        case EventSubType_New:
            return "New";
        case EventSubType_Update:
            return "Update";
        case EventSubType_Unitpaint:
            return "Unitpaint";
        case EventSubType_Delete:
            return "Delete";
        case EventSubType_Another:
            return "Another";
        default:
            return "";
    }
...
inline const EventType (&EnumValuesEventType())[6] {
    static const EventType values[] = {EventType_Unknown,  EventType_Actual,
                                       EventType_Revision, EventType_Estimate,
                                       EventType_Calendar, EventType_Another};
    return values;
}
...
inline const char *EnumNameEventType(EventType e) {
    switch (e) {
        case EventType_Unknown:
            return "Unknown";
        case EventType_Actual:
            return "Actual";
        case EventType_Revision:
            return "Revision";
        case EventType_Estimate:
            return "Estimate";
        case EventType_Calendar:
            return "Calendar";
        case EventType_Another:
            return "Another";
        default:
            return "";
    }
...
inline const SessionType (&EnumValuesSessionType())[6] {
    static const SessionType values[] = {
        SessionType_Unknowk,           SessionType_SessionConnectionUp,
        SessionType_SessionStarted,    SessionType_SessionConnectionDown,
        SessionType_SessionTerminated, SessionType_Another};
    return values;
}

inline const char *EnumNameSessionType(SessionType e) {
    switch (e) {
        case SessionType_Unknowk:
            return "Unknowk";
        case SessionType_SessionConnectionUp:
            return "SessionConnectionUp";
        case SessionType_SessionStarted:
            return "SessionStarted";
        case SessionType_SessionConnectionDown:
            return "SessionConnectionDown";
        case SessionType_SessionTerminated:
            return "SessionTerminated";
        case SessionType_Another:
            return "Another";
        default:
            return "";
    }
...
inline const Message (&EnumValuesMessage())[4] {
    static const Message values[] = {
        Message_NONE, Message_HeadlineEconomicEvent,
        Message_HeadlineCalendarEvent, Message_LogMessage};
    return values;
}

inline const char *const *EnumNamesMessage() {
    static const char *const names[5] = {"NONE", "HeadlineEconomicEvent",
                                         "HeadlineCalendarEvent", "LogMessage",
                                         nullptr};
    return names;
}

inline const char *EnumNameMessage(Message e) {
    if (::flatbuffers::IsOutRange(e, Message_NONE, Message_LogMessage))
        return "";
...
template <>
struct MessageTraits<BlpConn::FB::HeadlineEconomicEvent> {
    static const Message enum_value = Message_HeadlineEconomicEvent;
};

template <>
struct MessageTraits<BlpConn::FB::HeadlineCalendarEvent> {
    static const Message enum_value = Message_HeadlineCalendarEvent;
};

template <>
struct MessageTraits<BlpConn::FB::LogMessage> {
    static const Message enum_value = Message_LogMessage;
};

bool VerifyMessage(::flatbuffers::Verifier &verifier, const void *obj,
                   Message type);
...
struct DateTime FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    ...
    uint64_t micros() const { return GetField<uint64_t>(VT_MICROS, 0); }
    int16_t offset() const { return GetField<int16_t>(VT_OFFSET, 0); }
...
inline ::flatbuffers::Offset<DateTime> CreateDateTime(
    ::flatbuffers::FlatBufferBuilder &_fbb, uint64_t micros = 0,
    int16_t offset = 0) {
...
struct Value FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    ...
    double number() const { return GetField<double>(VT_NUMBER, 0.0); }
    double value() const { return GetField<double>(VT_VALUE, 0.0); }
    double low() const { return GetField<double>(VT_LOW, 0.0); }
    double high() const { return GetField<double>(VT_HIGH, 0.0); }
    double median() const { return GetField<double>(VT_MEDIAN, 0.0); }
    double average() const { return GetField<double>(VT_AVERAGE, 0.0); }
...
struct ValueBuilder {
    ...
    void add_standard_deviation(double standard_deviation) {
        fbb_.AddElement<double>(Value::VT_STANDARD_DEVIATION,
...
inline ::flatbuffers::Offset<Value> CreateValue(
    ::flatbuffers::FlatBufferBuilder &_fbb, double number = 0.0,
    double value = 0.0, double low = 0.0, double high = 0.0,
    double median = 0.0, double average = 0.0,
...
struct HeadlineEconomicEvent FLATBUFFERS_FINAL_CLASS
    ...
    BlpConn::FB::EventType event_type() const {
        return static_cast<BlpConn::FB::EventType>(
            GetField<uint8_t>(VT_EVENT_TYPE, 0));
    }
    BlpConn::FB::EventSubType event_subtype() const {
        return static_cast<BlpConn::FB::EventSubType>(
            GetField<uint8_t>(VT_EVENT_SUBTYPE, 0));
    }
    uint64_t event_id() const { return GetField<uint64_t>(VT_EVENT_ID, 0); }
    ...
    const ::flatbuffers::String *prior_observation_period() const {
        return GetPointer<const ::flatbuffers::String *>(
            VT_PRIOR_OBSERVATION_PERIOD);
    }
    const BlpConn::FB::DateTime *prior_economic_release_start_dt() const {
        return GetPointer<const BlpConn::FB::DateTime *>(
            VT_PRIOR_ECONOMIC_RELEASE_START_DT);
    }
    const BlpConn::FB::DateTime *prior_economic_release_end_dt() const {
        return GetPointer<const BlpConn::FB::DateTime *>(
            VT_PRIOR_ECONOMIC_RELEASE_END_DT);
    }
    bool Verify(::flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) &&
...
struct HeadlineEconomicEventBuilder {
    ...
    ::flatbuffers::FlatBufferBuilder &fbb_;
    ::flatbuffers::uoffset_t start_;
    void add_id_bb_global(
        ::flatbuffers::Offset<::flatbuffers::String> id_bb_global) {
        fbb_.AddOffset(HeadlineEconomicEvent::VT_ID_BB_GLOBAL, id_bb_global);
    }
    void add_parsekyable_des(
        ::flatbuffers::Offset<::flatbuffers::String> parsekyable_des) {
        fbb_.AddOffset(HeadlineEconomicEvent::VT_PARSEKYABLE_DES,
                       parsekyable_des);
    }
    ...
    void add_event_type(BlpConn::FB::EventType event_type) {
        fbb_.AddElement<uint8_t>(HeadlineEconomicEvent::VT_EVENT_TYPE,
                                 static_cast<uint8_t>(event_type), 0);
    }
    void add_event_subtype(BlpConn::FB::EventSubType event_subtype) {
        fbb_.AddElement<uint8_t>(HeadlineEconomicEvent::VT_EVENT_SUBTYPE,
                                 static_cast<uint8_t>(event_subtype), 0);
    }
    void add_event_id(uint64_t event_id) {
        fbb_.AddElement<uint64_t>(HeadlineEconomicEvent::VT_EVENT_ID, event_id,
                                  0);
    }
    void add_observation_period(
        ::flatbuffers::Offset<::flatbuffers::String> observation_period) {
        fbb_.AddOffset(HeadlineEconomicEvent::VT_OBSERVATION_PERIOD,
                       observation_period);
    }
    void add_release_start_dt(
        ::flatbuffers::Offset<BlpConn::FB::DateTime> release_start_dt) {
        fbb_.AddOffset(HeadlineEconomicEvent::VT_RELEASE_START_DT,
                       release_start_dt);
    }
    void add_release_end_dt(
        ::flatbuffers::Offset<BlpConn::FB::DateTime> release_end_dt) {
        fbb_.AddOffset(HeadlineEconomicEvent::VT_RELEASE_END_DT,
                       release_end_dt);
    }
    void add_value(::flatbuffers::Offset<BlpConn::FB::Value> value) {
        fbb_.AddOffset(HeadlineEconomicEvent::VT_VALUE, value);
    }
    void add_prior_value(
        ::flatbuffers::Offset<BlpConn::FB::Value> prior_value) {
        fbb_.AddOffset(HeadlineEconomicEvent::VT_PRIOR_VALUE, prior_value);
    }
    void add_prior_event_id(int32_t prior_event_id) {
        fbb_.AddElement<int32_t>(HeadlineEconomicEvent::VT_PRIOR_EVENT_ID,
                                 prior_event_id, 0);
    }
    void add_prior_observation_period(
        ::flatbuffers::Offset<::flatbuffers::String> prior_observation_period) {
        fbb_.AddOffset(HeadlineEconomicEvent::VT_PRIOR_OBSERVATION_PERIOD,
                       prior_observation_period);
    }
    void add_prior_economic_release_start_dt(
        ::flatbuffers::Offset<BlpConn::FB::DateTime>
            prior_economic_release_start_dt) {
        fbb_.AddOffset(
            HeadlineEconomicEvent::VT_PRIOR_ECONOMIC_RELEASE_START_DT,
            prior_economic_release_start_dt);
    }
    void add_prior_economic_release_end_dt(
        ::flatbuffers::Offset<BlpConn::FB::DateTime>
            prior_economic_release_end_dt) {
        fbb_.AddOffset(HeadlineEconomicEvent::VT_PRIOR_ECONOMIC_RELEASE_END_DT,
                       prior_economic_release_end_dt);
    }
    explicit HeadlineEconomicEventBuilder(
...
inline ::flatbuffers::Offset<HeadlineEconomicEvent> CreateHeadlineEconomicEvent(
    ...
    ::flatbuffers::Offset<BlpConn::FB::DateTime>
        prior_economic_release_start_dt = 0,
    ::flatbuffers::Offset<BlpConn::FB::DateTime> prior_economic_release_end_dt =
        0) {
    ...
    builder_.add_prior_economic_release_start_dt(
        prior_economic_release_start_dt);
...
inline ::flatbuffers::Offset<HeadlineEconomicEvent>
CreateHeadlineEconomicEventDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb, const char *id_bb_global = nullptr,
    const char *parsekyable_des = nullptr, const char *description = nullptr,
    BlpConn::FB::EventType event_type = BlpConn::FB::EventType_Unknown,
    BlpConn::FB::EventSubType event_subtype = BlpConn::FB::EventSubType_Unknown,
    uint64_t event_id = 0, const char *observation_period = nullptr,
    ::flatbuffers::Offset<BlpConn::FB::DateTime> release_start_dt = 0,
    ::flatbuffers::Offset<BlpConn::FB::DateTime> release_end_dt = 0,
    ::flatbuffers::Offset<BlpConn::FB::Value> value = 0,
    ::flatbuffers::Offset<BlpConn::FB::Value> prior_value = 0,
    int32_t prior_event_id = 0, const char *prior_observation_period = nullptr,
    ::flatbuffers::Offset<BlpConn::FB::DateTime>
        prior_economic_release_start_dt = 0,
    ::flatbuffers::Offset<BlpConn::FB::DateTime> prior_economic_release_end_dt =
        0) {
    auto id_bb_global__ = id_bb_global ? _fbb.CreateString(id_bb_global) : 0;
    auto parsekyable_des__ =
        parsekyable_des ? _fbb.CreateString(parsekyable_des) : 0;
    auto description__ = description ? _fbb.CreateString(description) : 0;
    auto observation_period__ =
        observation_period ? _fbb.CreateString(observation_period) : 0;
    auto prior_observation_period__ =
        prior_observation_period ? _fbb.CreateString(prior_observation_period)
                                 : 0;
    return BlpConn::FB::CreateHeadlineEconomicEvent(
        _fbb, id_bb_global__, parsekyable_des__, description__, event_type,
        event_subtype, event_id, observation_period__, release_start_dt,
        release_end_dt, value, prior_value, prior_event_id,
        prior_observation_period__, prior_economic_release_start_dt,
        prior_economic_release_end_dt);
}

struct HeadlineCalendarEvent FLATBUFFERS_FINAL_CLASS
    : private ::flatbuffers::Table {
    ...
    int32_t event_id() const { return GetField<int32_t>(VT_EVENT_ID, 0); }
    const ::flatbuffers::String *observation_period() const {
        return GetPointer<const ::flatbuffers::String *>(VT_OBSERVATION_PERIOD);
    }
    const BlpConn::FB::DateTime *release_start_dt() const {
    ...
    BlpConn::FB::ReleaseStatus release_status() const {
        return static_cast<BlpConn::FB::ReleaseStatus>(
            GetField<uint8_t>(VT_RELEASE_STATUS, 0));
    }
    bool Verify(::flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) &&
               VerifyOffsetRequired(verifier, VT_ID_BB_GLOBAL) &&
...
struct HeadlineCalendarEventBuilder {
    ...
    void add_parsekyable_des(
        ::flatbuffers::Offset<::flatbuffers::String> parsekyable_des) {
        fbb_.AddOffset(HeadlineCalendarEvent::VT_PARSEKYABLE_DES,
                       parsekyable_des);
    }
    void add_description(
        ::flatbuffers::Offset<::flatbuffers::String> description) {
    ...
    void add_event_type(BlpConn::FB::EventType event_type) {
        fbb_.AddElement<uint8_t>(HeadlineCalendarEvent::VT_EVENT_TYPE,
                                 static_cast<uint8_t>(event_type), 0);
    }
    void add_event_subtype(BlpConn::FB::EventSubType event_subtype) {
        fbb_.AddElement<uint8_t>(HeadlineCalendarEvent::VT_EVENT_SUBTYPE,
                                 static_cast<uint8_t>(event_subtype), 0);
    }
    void add_event_id(int32_t event_id) {
        fbb_.AddElement<int32_t>(HeadlineCalendarEvent::VT_EVENT_ID, event_id,
                                 0);
    }
    void add_observation_period(
        ::flatbuffers::Offset<::flatbuffers::String> observation_period) {
        fbb_.AddOffset(HeadlineCalendarEvent::VT_OBSERVATION_PERIOD,
                       observation_period);
    }
    void add_release_start_dt(
        ::flatbuffers::Offset<BlpConn::FB::DateTime> release_start_dt) {
        fbb_.AddOffset(HeadlineCalendarEvent::VT_RELEASE_START_DT,
                       release_start_dt);
    }
    void add_release_end_dt(
        ::flatbuffers::Offset<BlpConn::FB::DateTime> release_end_dt) {
        fbb_.AddOffset(HeadlineCalendarEvent::VT_RELEASE_END_DT,
                       release_end_dt);
    }
    void add_release_status(BlpConn::FB::ReleaseStatus release_status) {
        fbb_.AddElement<uint8_t>(HeadlineCalendarEvent::VT_RELEASE_STATUS,
                                 static_cast<uint8_t>(release_status), 0);
    }
    explicit HeadlineCalendarEventBuilder(
        ::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline ::flatbuffers::Offset<HeadlineCalendarEvent> CreateHeadlineCalendarEvent(
    ...
    ::flatbuffers::Offset<BlpConn::FB::DateTime> release_start_dt = 0,
    ::flatbuffers::Offset<BlpConn::FB::DateTime> release_end_dt = 0,
    BlpConn::FB::ReleaseStatus release_status =
        BlpConn::FB::ReleaseStatus_Unknown) {
...
inline ::flatbuffers::Offset<HeadlineCalendarEvent>
CreateHeadlineCalendarEventDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb, const char *id_bb_global = nullptr,
    const char *parsekyable_des = nullptr, const char *description = nullptr,
    BlpConn::FB::EventType event_type = BlpConn::FB::EventType_Unknown,
    BlpConn::FB::EventSubType event_subtype = BlpConn::FB::EventSubType_Unknown,
    int32_t event_id = 0, const char *observation_period = nullptr,
    ::flatbuffers::Offset<BlpConn::FB::DateTime> release_start_dt = 0,
    ::flatbuffers::Offset<BlpConn::FB::DateTime> release_end_dt = 0,
    BlpConn::FB::ReleaseStatus release_status =
        BlpConn::FB::ReleaseStatus_Unknown) {
...
struct LogMessage FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    ...
    uint8_t module_() const { return GetField<uint8_t>(VT_MODULE_, 0); }
...
struct LogMessageBuilder {
    ...
    void add_correlation_id(uint64_t correlation_id) {
        fbb_.AddElement<uint64_t>(LogMessage::VT_CORRELATION_ID, correlation_id,
                                  0);
    }
...
inline ::flatbuffers::Offset<LogMessage> CreateLogMessage(
    ...
    uint8_t module_ = 0, uint8_t status = 0, uint64_t correlation_id = 0,
...
inline ::flatbuffers::Offset<LogMessage> CreateLogMessageDirect(
    ...
    return BlpConn::FB::CreateLogMessage(_fbb, log_dt, module_, status,
                                         correlation_id, message__);
}
...
struct Main FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    ...
    BlpConn::FB::Message message_type() const {
        return static_cast<BlpConn::FB::Message>(
    ...
    const BlpConn::FB::HeadlineEconomicEvent *message_as_HeadlineEconomicEvent()
        const {
        return message_type() == BlpConn::FB::Message_HeadlineEconomicEvent
                   ? static_cast<const BlpConn::FB::HeadlineEconomicEvent *>(
                         message())
                   : nullptr;
    }
    const BlpConn::FB::HeadlineCalendarEvent *message_as_HeadlineCalendarEvent()
        const {
        return message_type() == BlpConn::FB::Message_HeadlineCalendarEvent
                   ? static_cast<const BlpConn::FB::HeadlineCalendarEvent *>(
                         message())
                   : nullptr;
    }
    const BlpConn::FB::LogMessage *message_as_LogMessage() const {
        return message_type() == BlpConn::FB::Message_LogMessage
                   ? static_cast<const BlpConn::FB::LogMessage *>(message())
                   : nullptr;
    }
    bool Verify(::flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) &&
...
template <>
inline const BlpConn::FB::HeadlineEconomicEvent *
Main::message_as<BlpConn::FB::HeadlineEconomicEvent>() const {
    return message_as_HeadlineEconomicEvent();
}

template <>
inline const BlpConn::FB::HeadlineCalendarEvent *
Main::message_as<BlpConn::FB::HeadlineCalendarEvent>() const {
    return message_as_HeadlineCalendarEvent();
}

template <>
inline const BlpConn::FB::LogMessage *
Main::message_as<BlpConn::FB::LogMessage>() const {
...
struct MainBuilder {
    ...
    void add_message_type(BlpConn::FB::Message message_type) {
        fbb_.AddElement<uint8_t>(Main::VT_MESSAGE_TYPE,
                                 static_cast<uint8_t>(message_type), 0);
    }
    void add_message(::flatbuffers::Offset<void> message) {
        fbb_.AddOffset(Main::VT_MESSAGE, message);
    }
    explicit MainBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline bool VerifyMessage(::flatbuffers::Verifier &verifier, const void *obj,
                          Message type) {
    switch (type) {
        case Message_NONE: {
            return true;
        ...
        case Message_HeadlineEconomicEvent: {
            auto ptr =
                reinterpret_cast<const BlpConn::FB::HeadlineEconomicEvent *>(
                    obj);
            return verifier.VerifyTable(ptr);
        }
        case Message_HeadlineCalendarEvent: {
            auto ptr =
                reinterpret_cast<const BlpConn::FB::HeadlineCalendarEvent *>(
                    obj);
            return verifier.VerifyTable(ptr);
        }
...
inline bool VerifyMessageVector(
    ...
    for (::flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
        if (!VerifyMessage(verifier, values->Get(i),
                           types->GetEnum<Message>(i))) {
            return false;
        }
    }
    return true;
