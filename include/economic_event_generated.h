...
#ifndef FLATBUFFERS_GENERATED_ECONOMICEVENT_BLPCONN_FB_H_
#define FLATBUFFERS_GENERATED_ECONOMICEVENT_BLPCONN_FB_H_
...
enum EconomicEvent : uint8_t {
  EconomicEvent_NONE = 0,
  EconomicEvent_HeadlineEconomicEvent = 1,
  EconomicEvent_HeadlineCalendarEvent = 2,
  EconomicEvent_MIN = EconomicEvent_NONE,
  EconomicEvent_MAX = EconomicEvent_HeadlineCalendarEvent
};

inline const EconomicEvent (&EnumValuesEconomicEvent())[3] {
  static const EconomicEvent values[] = {
    EconomicEvent_NONE,
    EconomicEvent_HeadlineEconomicEvent,
    EconomicEvent_HeadlineCalendarEvent
  };
  return values;
}

inline const char * const *EnumNamesEconomicEvent() {
...
inline const char *EnumNameEconomicEvent(EconomicEvent e) {
  if (::flatbuffers::IsOutRange(e, EconomicEvent_NONE, EconomicEvent_HeadlineCalendarEvent)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEconomicEvent()[index];
}

template<typename T> struct EconomicEventTraits {
  static const EconomicEvent enum_value = EconomicEvent_NONE;
};

template<> struct EconomicEventTraits<BlpConn::FB::HeadlineEconomicEvent> {
  static const EconomicEvent enum_value = EconomicEvent_HeadlineEconomicEvent;
};

template<> struct EconomicEventTraits<BlpConn::FB::HeadlineCalendarEvent> {
  static const EconomicEvent enum_value = EconomicEvent_HeadlineCalendarEvent;
};

bool VerifyEconomicEvent(::flatbuffers::Verifier &verifier, const void *obj, EconomicEvent type);
bool VerifyEconomicEventVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<uint8_t> *types);
...
inline bool VerifyEconomicEvent(::flatbuffers::Verifier &verifier, const void *obj, EconomicEvent type) {
  switch (type) {
    case EconomicEvent_NONE: {
      return true;
    }
    case EconomicEvent_HeadlineEconomicEvent: {
      auto ptr = reinterpret_cast<const BlpConn::FB::HeadlineEconomicEvent *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case EconomicEvent_HeadlineCalendarEvent: {
...
inline bool VerifyEconomicEventVector(::flatbuffers::Verifier &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<uint8_t> *types) {
  if (!values || !types) return !values && !types;
  if (values->size() != types->size()) return false;
  for (::flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyEconomicEvent(
        verifier,  values->Get(i), types->GetEnum<EconomicEvent>(i))) {
      return false;
    }
  }
  return true;
...
#endif  // FLATBUFFERS_GENERATED_ECONOMICEVENT_BLPCONN_FB_H_
